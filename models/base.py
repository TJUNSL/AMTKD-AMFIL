...
class BaseLearner(object):
    ...
    def eval_task(self, save_conf=False):
        ...
        # print("the y_pred type is ", type(y_pred))
        # print("the y_pred shape is",y_pred.shape)
        # print("the y_true is :",y_true)
        # print("the y_true type is ", type(y_true))
        # print("the y_true shape is",y_true.shape)
    ...
    def _construct_exemplar(self, data_manager, m):
        ...
        for class_idx in range(self._known_classes, self._total_classes):
            ...
            if len(data) < m:
                ...
                # print(f'the class of {class_idx} has {len(data)} exemplars')
                last_data = data[-1]
                ...
                # print(f'the class of {class_idx} has {len(selected_exemplars)} exemplars')
