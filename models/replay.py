...
class Replay(BaseLearner):
    ...
    def _init_train(self, train_loader, test_loader, optimizer, scheduler):
        ...
        plt.savefig("replayivirusshareDataset60-120_confusion_matrix.png")
        plt.close()
    ...
    def _update_representation(self, train_loader, test_loader, optimizer, scheduler):
        ...
        ax.set_ylabel("True labels")
        ax.set_title("Confusion Matrix")
        plt.savefig("replayiAMDDataset25-35without_MYmethod_confusion_matrix.png")
        plt.close()
        ...
        # print('Micro precision', round(micro_precision * 100, 2), '%')  
        
        # micro_recall = recall_score(y_true, y_pred, average='micro')  
        # print('Micro recall', round(micro_recall * 100, 2), '%')  
        
        # micro_f1 = f1_score(y_true, y_pred, average='micro')  
        # print('Micro f1-score', round(micro_f1 * 100, 2), '%')
        
        # logging.info("prune eval: ")
