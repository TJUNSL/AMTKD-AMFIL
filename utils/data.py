...
class iDrebin(iData):
    ...
    common_trsf = [
        transforms.ToTensor(),
        transforms.Normalize(mean=[0.201], std=[0.126]),
    ]
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = r'Drebin/train'
        test_dir = r'Drebin/test'
...
class iVirusshareImg(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = r'Virustotal/train'
        test_dir = r'Virustotal/test'
...
class iVirusshareYearsImg(iData):
    ...
    common_trsf = [
        transforms.ToTensor(),
        transforms.Normalize(mean=[0.2598], std=[0.1879]),
    ]

    class_order = np.arange(48).tolist()
